        ...
        <div class="navbar-inner">
            <div class="container">
                <ul class="nav" ng-controller="LocationController">
					...
					<li ng-class="{'gray': activeURL == 'dishes', '': activeURL != 'dishes'}"><a title='<spring:message code="header.dishes"/>' href="<c:url value='/protected/dishes'/>"><p><spring:message code="header.dishes"/></p></a></li>
